...
class Consulting2 extends Component{
                  ...
                  <View style={{flex:1,alignItems:'center',marginEnd:'6%',}}>
                   ...
                   <Image
                    ...
                    style={{  width: 100,height:100,alignItems: 'center',}}/>
                     ...
                     <Text style={{color:'#262626', fontSize: 14,fontFamily:'adobe',textAlign:'center',fontWeight:'bold'}}>
                    {item.fullname}
                 </Text>
                 <Text style={{width:'90%',color:'#707070', fontSize: 18,fontFamily:'adobe',textAlign:'center'}}>
                    {item.experiences}
                 </Text>
                  </View>
                </View>
                <View style={{width:'90%',height:1,backgroundColor:'#E4E4E4',marginTop:5,marginBottom:10}}/>
                 <Text style={{width:'100%',color:'#393939', fontSize: 16,fontFamily:'adobe',textAlign:'center',fontWeight:'bold'}}>
    ...
    render(){
        return(
            ...
            <View style={{width:'100%',height:'100%',alignItems:'center',justifyContent:'center',marginBottom:20}}>
              ...
              <TouchableOpacity 
                onPress={() => {
                  ...
                  this.setState({bg3:'#F6F6F6'})
                  // this.props.getSpecialist(3)
                  this.getData(3)
                }}
                   style={[styles.shadow,{flex:1,alignItems:'center',justifyContent:'center',backgroundColor:this.state.bg1 }]} >
                 <Text style={{fontSize: 15,color:'#707070',fontFamily:'adobe',textAlign:'center',padding:3}}>
                   {this.props.Language == "AR" ? 'نطق وتخاطب' : 'Speak and speak'}</Text>
               </TouchableOpacity>
               ...
               <TouchableOpacity 
                onPress={() => {
                  ...
                  this.getData(2)
                   ...
                   style={[styles.shadow,{flex:1,alignItems:'center',justifyContent:'center',backgroundColor:this.state.bg3 }]} >
                 <Text style={{fontSize: 15,color:'#707070',fontFamily:'adobe',textAlign:'center',padding:3}}>
            ...
            <FlatList style={{marginTop:5,marginBottom:'15%'}}
...
const mapStateToProps = state => {
 ...
 // redux
 export default connect(mapStateToProps, { SetLoading, getSpecialist})(Consulting2)
