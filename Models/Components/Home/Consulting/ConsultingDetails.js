...
import { SetLoading , getConsultingById , StartChat} from './../../../Actions' //redux
...
class ReservationRequest extends Component {
    constructor(props) {
        super(props);
        this.state = {
            radioSelected1:this.props.ConsultingByID.type,
            radioSelected2:this.props.ConsultingByID.level,
            radioSelected3:this.props.ConsultingByID.stutteringSide,
            radioSelected4:this.props.ConsultingByID.anotherOne,
            radioSelected5:this.props.ConsultingByID.family,
            isVisible:false,
        };
    }
    ...
    componentWillReceiveProps= async(nextProps)=> {
        if (nextProps.Message != null) {
           if(nextProps.Message =='Start chat done'){
            const obj={
                userID: this.props.ConsultingByID.usrID,
                fullname: this.props.ConsultingByID.fullname,
                imgPath: this.props.ConsultingByID.imgPath,
                type: this.props.ConsultingByID.type,
                key:1,
                consultingID: this.props.ConsultingByID.id
              }
            this.props.navigation.navigate('SpecialistChat',{UserChat:JSON.stringify(obj)})
            AsyncStorage.setItem('consultingID', this.props.ConsultingByID.id)
           }else{
    ...
    componentWillMount(){
        ...
        this.props.getConsultingById(id)
    ...
    apologize(){
       ...
       NetInfo.fetch().then(state =>{
         if (state.isConnected){
           try {
             axios.put('http://68.183.39.113/api/user/requestApologise/'+this.props.ConsultingByID.id,{
                status: 2
             }).then(response => {
        ...
        if (lang == "EN") {
            return (
                <View style={[styles.flex, styles.row, styles.shadow, { width: width, height: 55, alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#28B5AF', paddingHorizontal: 18 }]} >
                    <View></View>
                    <Text style={{ color: '#F6F6F6', fontSize: 22,fontFamily:'adobe' }}>{this.props.ConsultingByID.fullname}</Text>
                    <TouchableOpacity onPress={() => this.props.navigation.goBack()} >
                        <FontAwesome name="chevron-right" style={{ color: '#ffffff', fontSize: 14 }} />
                    </TouchableOpacity>
                </View>
            )
        } else {
            return (
                <View style={[styles.flex, styles.row, styles.shadow, { width: width, height: 55, alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#28B5AF', paddingHorizontal: 18 }]} >
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.goBack()} >
                        <FontAwesome name="chevron-left" style={{ color: '#ffffff', fontSize: 14 }} />
                    </TouchableOpacity>
                    <Text style={{ color: '#F6F6F6', fontSize: 22,fontFamily:'adobe' }}>{this.props.ConsultingByID.fullname}</Text>
                    <View></View>
                </View>
    ...
    renderRadio1(clicked){
        return(
         ...
         onPress={()=>{
           ...
           {this.props.ConsultingByID.type === clicked?
      ...
      renderRadio2(clicked){
        return(
         ...
         onPress={()=>{
           ...
           {this.props.ConsultingByID.level === clicked?
           <LinearGradient colors={['#47D9D3', '#3D7371']} style={{width:15 ,height:15 ,borderRadius:15/2,}}>
           </LinearGradient>
           :
           <View style={{display:'none'}}></View>
      ...
      renderRadio3(clicked){
        return(
         ...
         onPress={()=>{
           ...
           {this.props.ConsultingByID.stutteringSide === clicked?
           <LinearGradient colors={['#47D9D3', '#3D7371']} style={{width:15 ,height:15 ,borderRadius:15/2,}}>
           </LinearGradient>
           :
           <View style={{display:'none'}}></View>
      ...
      renderRadio4(clicked){
        return(
         ...
         onPress={()=>{
           ...
           {this.props.ConsultingByID.anotherOne === clicked?
           <LinearGradient colors={['#47D9D3', '#3D7371']} style={{width:15 ,height:15 ,borderRadius:15/2,}}>
           </LinearGradient>
           :
           <View style={{display:'none'}}></View>
      ...
      renderRadio5(clicked){
        return(
         ...
         onPress={()=>{
           ...
           {this.props.ConsultingByID.family === clicked?
           <LinearGradient colors={['#47D9D3', '#3D7371']} style={{width:15 ,height:15 ,borderRadius:15/2,}}>
           </LinearGradient>
           :
           <View style={{display:'none'}}></View>
        ...
        return (
            <View style={styles.container} >
                ...
                <View style={{ width: '50%', height:'100%',justifyContent:'center',}}>
                  ...
                  {this.props.ConsultingByID.fullname}
                  </Text>
                  ...
                  {this.props.Language == "AR" ? this.props.ConsultingByID.type===1?'المريض':'متابع المريض' : this.props.ConsultingByID.type===1?'Patient':'Patient follower'}
                  </Text>
                </View>
                <View style={{ width: '25%', height:'100%', alignItems: 'center',justifyContent:'center'}}>
                <Image
                    source={{uri: this.props.ConsultingByID.imgPath}} style={{ width: 70, height: 70, borderRadius:70/2 }}>
                  </Image>
                </View>
              </View>
                         ...
                         <View style={[styles.row, { justifyContent: 'center', alignItems: 'center', }]} >
                            <Item style={[styles.inputFields, styles.shadow, { marginTop: 3,marginBottom:3 }]}>
                                <Input
                                    ...
                                    textAlign={'center'}
                                    defaultValue={this.props.ConsultingByID.age}
                        ...
                        <View style={[styles.row, { justifyContent: 'center', alignItems: 'center' }]} >
                            <Item style={[styles.inputFields, styles.shadow, { marginTop: 3,marginBottom:3 }]}>
                                <Input
                                    style={{ color: '#000',fontSize:18,fontFamily:'adobe' }}
                                    textAlign={'center'}
                                    defaultValue={this.props.ConsultingByID.begin}
                        ...
                        <View style={[styles.row, { justifyContent: 'center', alignItems: 'center' }]} >
                            <Item style={[styles.inputFields, styles.shadow, { marginTop: 3,marginBottom:3 }]}>
                                <Input
                                    style={{ color: '#000',fontSize:18,fontFamily:'adobe' }}
                                    textAlign={'center'}
                                    defaultValue={this.props.ConsultingByID.reason?this.props.ConsultingByID.reason:'No answer'}
                    ...
                    <View style={[styles.row, { justifyContent: 'center', alignItems: 'center' }]} >
                            <Item style={[styles.inputFields, styles.shadow, { marginTop: 3,marginBottom:3 }]}>
                                <Input
                                    ...
                                    textAlign={'center'}
                                    defaultValue={this.props.ConsultingByID.increase?this.props.ConsultingByID.increase:'No answer'}
                    ...
                    <View style={[styles.row, { justifyContent: 'center', alignItems: 'center' }]} >
                            <Item style={[styles.inputFields, styles.shadow, { marginTop: 3,marginBottom:3 }]}>
                                <Input
                                    ...
                                    style={{ color: '#000',fontSize:15,fontFamily:'adobe',textAlignVertical:'top' }}
                                    textAlign={'center'}
                                    defaultValue={this.props.ConsultingByID.examples?this.props.ConsultingByID.examples:'No answer'}
                        ...
                        <View style={[styles.row, { justifyContent: 'center', alignItems: 'center' }]} >
                            <Item style={[styles.inputFields, styles.shadow, { marginTop: 3,marginBottom:3 }]}>
                                <Input
                                    ...
                                    style={{ color: '#000',fontSize:15,fontFamily:'adobe',textAlignVertical:'top' }}
                                    textAlign={'center'}
                                    defaultValue={this.props.ConsultingByID.feeling?this.props.ConsultingByID.feeling:'No answer'}
                        ...
                        <LinearGradient colors={['#47D9D3', '#3D7371']} style={[styles.Button,styles.shadow,]}>
                            ...
                            onPress={() => { 
                                // this.props.navigation.navigate('SpecialistChat') 
                                 this.props.StartChat(this.props.ConsultingByID.usrID,this.props.User._id ,1)
                            }}
                             style={[styles.shadow, {width:width*0.8,alignItems:'center',justifyContent:'center'}]} >
                                <Text style={{ color: '#FFF', fontSize: 19, fontFamily:'adobe' }}>
                                    {this.props.Language == "AR" ? 'بدأ الأستشارة' : 'Start consulting'}
                                </Text>
                            </TouchableOpacity>
                            </LinearGradient>
                        </View>
...
// redux
export default connect(mapStateToProps, { SetLoading , getConsultingById , StartChat})(ReservationRequest)
