        ...
        if (lang == "AR") {
           return (
              <View style={[styles.flex, styles.row, styles.shadow, { width: width, height: 55, alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#28B5AF', paddingHorizontal: 18 }]} >
                 ...
                 <Text style={{ color: '#fff', fontSize: 22,fontFamily:'adobe' }}>مكالمة فيديو</Text>
                 <View></View>
              </View>
           )
        } else {
           return (
              <View style={[styles.flex, styles.row, styles.shadow, { width: width, height: 55, alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#28B5AF', paddingHorizontal: 18 }]} >
                 <View></View>
                 <Text style={{ color: '#fff', fontSize: 22,fontFamily:'adobe' }}> VideoScreen</Text>
                 <TouchableOpacity onPress={() => this.props.navigation.goBack()} >
...
const mapStateToProps = state => {
 ...
 // redux
 export default connect(mapStateToProps,{ SetLoading})(VideoScreen)
