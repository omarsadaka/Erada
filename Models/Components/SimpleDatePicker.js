      ...
      >
        <View style={{ flex: 1,flexDirection: 'row',}} >
          ...
          <View
            ...
            style={[dropdownStyle,
              { marginHorizontal: padding,flex: 0.3,height:35,
          ...
          <View
            ...
            style={[dropdownStyle,
              {marginRight: padding, flex: 0.5,height:35, borderColor: monthOpen ? highlightColor : disabledColor, }, ]}>
            <SimpleDropdown
              theme={theme}
              placeholder="شهر"
          ...
          <View
            ...
            style={[ dropdownStyle,
              { flex: 0.2,height:35, borderColor: dayOpen ? highlightColor : disabledColor,}, ]} >
            <SimpleDropdown
              theme={theme}
              placeholder="يوم"
