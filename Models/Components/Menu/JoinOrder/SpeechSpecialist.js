...
class SpeechSpecialist extends Component{
    constructor(props) {
        super(props);
        this.state = {
            Processing: false,
        ...
        if (lang == "AR") {
           return (
              <View style={[styles.flex, styles.row, styles.shadow, { width: width, height: 55, alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#28B5AF', paddingHorizontal: 18 }]} >
                 ...
                 <Text style={{ color: '#fff', fontSize: 22,fontFamily:'adobe' }}>أخصائى نطق وتخاطب</Text>
                 <View></View>
              </View>
           )
        } else {
           return (
              <View style={[styles.flex, styles.row, styles.shadow, { width: width, height: 55, alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#28B5AF', paddingHorizontal: 18 }]} >
                 <View></View>
                 <Text style={{ color: '#fff', fontSize: 22,fontFamily:'adobe' }}>Speech specialist</Text>
                 <TouchableOpacity onPress={() => {
                     if(this.state.chechBack === 1){
                     this.props.navigation.navigate('Register')
                    }else{
    ...
    render(){
        return(
            ...
            color='#28B5AF'
               ...
               textContent={this.props.Language=='AR'?'جارى التحميل':'Loading...'}
            ...
            <View style={[{flex: 1,alignItems:'center',justifyContent:'center'}]}>
               ...
               <View style={[this.props.Language == "AR" ? styles.rowReversed : styles.row, { justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 15, marginBottom: 16 }]}>
                  ...
                  <View style={[styles.row, { flex: 2, justifyContent: 'center', alignItems: 'center' }]}>
                     ...
                     dropdownStyle={[styles.shadow,{ width: '50%', height:120,borderRadius: 8,backgroundColor:'#FAFAFA',}]}
...
const mapStateToProps = state => {
 ...
 // redux
 export default connect(mapStateToProps,{ SetLoading , UserRegister})(SpeechSpecialist)
